...
@section('content')
    ...
    <section class="py-5">
        <div class="d-flex align-items-center justify-content-between mb-5">
            <h2 class="mb-0">Kategori {{ $province != null ? $province->name : 'Semua Provinsi' }}</h2>
        </div>
            ...
            <div class="container">
                <div class="row">
                    @foreach ($articles as $item)
                        <a href="{{ route('artikel.detail', $item->slug) }}" class="card mb-3 ms-2 text-decoration-none"
        ...
        {{-- @foreach ($articles as $item)
            <a href="{{ route('artikel.detail', $item->slug) }}" class="card bg-white mb-3 text-decoration-none">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-3">
                            <img src="{{ url('storage/' . $item->cover) }}" alt="{{ $item->title }}" class="w-100">
                        </div>
                        <div class="col-md-9">
